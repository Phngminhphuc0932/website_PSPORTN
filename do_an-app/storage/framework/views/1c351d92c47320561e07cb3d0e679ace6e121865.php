    ...
    <section id="main-content">
        <section class="wrapper">
            ...
            <ul class="pagination">
                ...
                <li class="page-item"><a class="page-link" onclick="process_load_page(<?php echo e($so_trang - 1); ?>)">Last</a></li>
            </ul>
...
<?php echo $__env->make('templates.template_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\website_PSPORTN\do_an-app\resources\views/page_admin/trang_ds_don_hang.blade.php ENDPATH**/ ?>